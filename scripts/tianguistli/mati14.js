...
var listaPregunta = [
    "chancada",
    "Se chancaca ipati sempoali iuan eyi tomi",
    "¿Quesqui tinequi?",
    "omepoali iuan chicuase peso"
];
...
function obtenerRespuestas(){
    ...
    switch(index){
        ...
        case 1:
            ...
            break;
        case 2:
            espaciosUsados = [idEspacio1, idEspacio2, idEspacio3];
            break;
        case 3:
...
function limpiarRespuestas(){
    ...
    if (index < listaPregunta.length) {
        ...
        window.location.href = "../../pages/tianguistli/mati14b.html";
    }
}
